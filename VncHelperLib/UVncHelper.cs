...
namespace VncHelperLib
{
    public class UVncHelper : NotifyPropertyObject
    {
        ...
        #region EditUltraIni ConnectPriority=1
        ...
        #region TryLaunchRemoteSupport_AfterReboot
